...
class UsersEventsListener
{
    ...
    public function subscribe($events)
    {
        $events->listen(
            ...
            'obsession\App\Listeners\Users\UsersEventsListener@handleUserCreatedEvent'
        );
        $events->listen(
            'obsession\Domain\Users\Users\Events\UserUpdatedEvent',
            'obsession\App\Listeners\Users\UsersEventsListener@handleUserUpdatedEvent'
        );
        $events->listen(
            'obsession\Domain\Users\Users\Events\UserDeletedEvent',
            'obsession\App\Listeners\Users\UsersEventsListener@handleUserDeletedEvent'
        );
        $events->listen(
            'obsession\Domain\Users\Users\Events\UserTriedToDeleteHisOwnAccountEvent',
            'obsession\App\Listeners\Users\UsersEventsListener@handleUserTriedToDeleteHisOwnAccountEventEvent'
        );
        $events->listen(
            'obsession\Domain\Users\Users\Events\UserRefreshSessionEvent',
            'obsession\App\Listeners\Users\UsersEventsListener@handleUserRefreshSessionEvent'
        );
    }
     ...
     */
    public function handleUserRefreshSessionEvent(UserRefreshSessionEvent $event)
    {
