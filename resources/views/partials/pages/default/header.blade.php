...
{{--                                        <a href="/#"--}}
{{--                                           class="text-complete pull-left">--}}
{{--                                            <i class="pg-map fs-16 m-r-10"></i>--}}
{{--                                            <span--}}
{{--                                                class="bold">Carrot Design</span>--}}
...
{{--                                    <div class="heading">--}}
{{--                                        <a href="/#"--}}
{{--                                           class="text-warning-dark pull-left">--}}
{{--                                            <i class="fa fa-exclamation-triangle m-r-10"></i>--}}
...
{{--                                                 data-src-retina="/img/profiles/1x.jpg"--}}
{{--                                                 data-src="/img/profiles/1.jpg"--}}
{{--                                                 alt=""--}}
...
{{--        <a href="/#" class="search-link d-lg-inline-block d-none"--}}
{{--           data-toggle="search"><i class="pg-search"></i>Type anywhere to--}}
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="dropdown pull-right d-lg-block d-none">
            <button class="profile-dropdown-toggle" type="button"
              ...
              <img src="/img/profiles/avatar.jpg" alt=""
                   data-src="/img/profiles/avatar.jpg"
                   data-src-retina="/img/profiles/avatar_small2x.jpg" width="32"
                   height="32">
              </span>
            </button>
            <div class="dropdown-menu dropdown-menu-right profile-dropdown"
                ...
                <a href="/#" class="dropdown-item"><i
                        class="pg-settings_small"></i> Settings</a>
                <a href="/#" class="dropdown-item"><i
                        class="pg-outdent"></i> Feedback</a>
                <a href="/#" class="dropdown-item"><i
