    ...
    <nav class="bg-white border-bottom" aria-label="breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ trans('global.terms') }}</li>
            </ol>
        </div>
    </nav>
    <section>
...
{{--                                    Adresse<br>Adresse<br>France<br>--}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7 sm-m-t-20">
                                    <p>
                                        <a href="{{ route('frontend.home') }}">www.obsession.city</a> utilise des services d’analyses de site internet, pour ameliorer la qualité de son service, cela est fait de façon anonyme, ce qui signifie que les données transmisent aux services tiers ne peuvent vous identifier directement.
                                    </p>
                                </div>
                            </div>
