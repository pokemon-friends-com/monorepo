...
import { flatten, toArray, isObject } from 'lodash';
...
export default {
  ...
  mounted() {
    ...
    $('#modal-create-client').on('shown.bs.modal', () => {
      $('#create-client-name').trigger('focus');
    });

    $('#modal-edit-client').on('shown.bs.modal', () => {
      $('#edit-client-name').trigger('focus');
    });
  },
  ...
  methods: {
    ...
    persistClient(method, uri, form, modal) {
      ...
      axios[method](uri, currentForm)
        ...
        .catch((error) => {
          currentForm.errors = isObject(error.response.data)
            ? flatten(toArray(error.response.data.errors))
